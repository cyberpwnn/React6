...
public class GraphController extends Controller
{
	...
	public void toggleMapping(Player player)
	{
		if(!gr.containsKey(player))
		{
			...
			pg.add(new PointedGraph(new GraphText("TICK", g.get(SampledType.TICK).getGraphColor()), GraphSize.WIDE));
			...
			pg.add(new PointedGraph(new GraphText("MEMORY", g.get(SampledType.MEM).getGraphColor()), GraphSize.WIDE));
			...
			pg.add(new PointedGraph(new GraphText("PHYSICS", g.get(SampledType.REDSTONE_TIME).getGraphColor()), GraphSize.WIDE));
			...
			pg.add(new PointedGraph(new GraphText("REACT", g.get(SampledType.ATASK).getGraphColor()), GraphSize.WIDE));
