...
public class BlockInjector10 extends BlockInjector<Block, Blocks>
{
	public BlockInjector10(Protocol protocol, Class<? extends Blocks> blocksClass)
	{
