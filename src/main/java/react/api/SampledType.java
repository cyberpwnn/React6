...
public enum SampledType
{
	...
	HOPPER_TICK_USAGE(Info.SAMPLER_REDSTONE_TICK_USAGE),
	HOPPER_TICK(Info.SAMPLER_REDSTONE_TICK),
	HOPPER_SECOND(Info.SAMPLER_REDSTONE_SECOND),
	HOPPER_TIME(Info.SAMPLER_REDSTONE_TIME),
