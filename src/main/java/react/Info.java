...
public class Info
{
	...
	public static String SAMPLER_REDSTONE_TICK_USAGE = "Redstone UTick";
	public static String SAMPLER_REDSTONE_TICK = "Redstone/t";
	public static String SAMPLER_ENTITY_TIME = "Entity MS";
	public static String SAMPLER_ENTITY_TIME_LOCK = "Entity LCK";
	public static String SAMPLER_TILE_TIME_LOCK = "Tile LCK";
	public static String SAMPLER_TILE_TIME = "Tile MS";
	public static String SAMPLER_TILE_DROPTICK = "Tile DTick";
	public static String SAMPLER_ENTITY_DROPTICK = "Entity DTick";
	public static String SAMPLER_REDSTONE_SECOND = "Redstone/s";
	public static String SAMPLER_REDSTONE_TIME = "Redstone MS";
	public static String SAMPLER_HOPPER_TICK_USAGE = "Hopper UTick";
	public static String SAMPLER_HOPPER_TICK = "Hopper/t";
	public static String SAMPLER_HOPPER_SECOND = "Hopper/s";
	public static String SAMPLER_HOPPER_TIME = "Hopper MS";
	public static String SAMPLER_FLUID_TICK_USAGE = "Fluid UTick";
	public static String SAMPLER_FLUID_TICK = "Fluid/t";
	public static String SAMPLER_FLUID_SECOND = "Fluid/s";
	public static String SAMPLER_FLUID_TIME = "Fluid MS";
	public static String SAMPLER_TPS = "TPS";
	public static String SAMPLER_TICK = "Server Tick MS";
	public static String SAMPLER_TIU = "Load";
	public static String SAMPLER_MEM = "Used Mem";
	public static String SAMPLER_FREEMEM = "Free Mem";
	public static String SAMPLER_MAXMEM = "Max Mem";
	public static String SAMPLER_ALLOCMEM = "Allocated";
	public static String SAMPLER_MAHS = "MAH/s";
	public static String SAMPLER_CHK = "Loaded Chunks";
	public static String SAMPLER_ATASK = "Async Queue";
	public static String SAMPLER_STASK = "Sync Queue";
	public static String SAMPLER_CHK_TIME = "Chunk MS";
	public static String SAMPLER_CHKS = "Chunks/s";
	public static String SAMPLER_ENT = "Entities";
	public static String SAMPLER_ENTLIV = "Mobs";
	public static String SAMPLER_ENTDROP = "Drops";
	public static String SAMPLER_ENTTILE = "Tiles";
